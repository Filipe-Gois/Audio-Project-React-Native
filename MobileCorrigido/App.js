...
export default function App() {
  ...
  const [messages, setMessages] = useState([
    {
      ...
      user: "robot",
      type: "text",
      value: "Para funcionar, envie um texto ou um áudio para transcrição...",
    },
  ]);
  ...
  async function TextToSpeech() {
    await axios
      .post(
        "http://192.168.15.61:4056/TextToSpeech",
        {
          Texto: sendText,
        },
        {
  ...
  async function SpeechToText(uri) {
    ...
    await axios
      .post("http://192.168.15.61:4056/SpeechToText", form, {
        headers: {
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerTextContainer}>
          ...
          <Text style={styles.statusRobot}>
            {isTyping ? "Digitando..." : isRecording ? "Gravando..." : null}
          </Text>
        </View>
      </View>
